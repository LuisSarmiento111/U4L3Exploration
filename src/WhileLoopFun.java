public class WhileLoopFun
{
    ...
    public void printDigits(int number)
    {
        ...
        int count = 1;
        while (count < numAsString.length() + 1){
            System.out.println((int)(number % Math.pow(10,count) / Math.pow(10,count - 1)));
            count++;
        }
    }
    ...
    public int sumOfDigits(int number)
    {
        ...
        int i = 0;
        int count = 0;
        while (count < numAsString.length()){
            i += number % Math.pow(10,count + 1) / Math.pow(10,count);
            count ++;
        }
        return i;
    }
